...
// --- MAIN COMPONENT ---
const Careers = () => (
  <PageLayout title="Careers at TensorGo">
    {/* 1. Hero Section */}
    <section className="relative text-center py-24 px-6 overflow-hidden bg-gradient-to-br from-purple-800 to-indigo-900 text-white rounded-xl shadow-lg">
      ...
      <div className="relative z-10 animate-fade-in-up">
        ...
        <a 
          href="#openings" 
          className="inline-block py-3 px-8 bg-white text-indigo-700 font-bold text-lg rounded-full shadow-lg transition-transform transform hover:scale-105 hover:bg-gray-200"
        >
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          {jobOpenings.map((job) => (
            ...
            >
              ...
              <a 
                href="mailto:careers@tensorgo.com" 
                className={`flex-shrink-0 mt-4 md:mt-0 bg-${job.color}-600 text-white font-semibold py-2 px-6 rounded-lg hover:bg-${job.color}-700 transition-colors`}
              >
                Apply Now
              </a>
            </div>
